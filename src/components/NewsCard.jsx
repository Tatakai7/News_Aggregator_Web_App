...
const NewsCard = ({ article, onBookmark }) => {
  ...
  return (
    <div className="news-card flex flex-col h-full">
      <div className="relative overflow-hidden bg-gradient-to-br from-muted to-border h-48">
        {article.urlToImage ? (
          <>
            {!imageLoaded && (
              <div className="absolute inset-0 bg-gradient-to-br from-muted to-border animate-pulse"></div>
            )}
            <img
          ...
          <div className="w-full h-full bg-gradient-to-br from-secondary to-accent opacity-20 flex items-center justify-center">
